...
/**
* \addtogroup SSC-Device1 SSC-Device1
* @{
*/

/**
\file SSC-Device1Objects
\author ET9300Utilities.ApplicationHandler (Version 1.5.0.0) | EthercatSSC@beckhoff.com

\brief SSC-Device1 specific objects<br>
\brief NOTE : This file will be overwritten if a new object dictionary is generated!<br>
*/

#if defined(_SSC_DEVICE1_) && (_SSC_DEVICE1_ == 1)
#define PROTO
#else
#define PROTO extern
#endif
/******************************************************************************
*                    Object 0x1600 : OutputData process data mapping
******************************************************************************/
/**
* \addtogroup 0x1600 0x1600 | OutputData process data mapping
* @{
* \brief Object 0x1600 (OutputData process data mapping) definition
*/
#ifdef _OBJD_
/**
...
*/
OBJCONST UCHAR OBJMEM aName0x1600[] = "OutputData process data mapping\000"
"SubIndex 001\000\377";
#endif //#ifdef _OBJD_

#ifndef _SSC_DEVICE1_OBJECTS_H_
/**
...
TOBJ1600;
#endif //#ifndef _SSC_DEVICE1_OBJECTS_H_

/**
* \brief Object variable
*/
PROTO TOBJ1600 OutputDataProcessDataMapping0x1600
#if defined(_SSC_DEVICE1_) && (_SSC_DEVICE1_ == 1)
={1,0x70000110}
#endif
;
...
/******************************************************************************
*                    Object 0x7000 : OutputData
******************************************************************************/
/**
* \addtogroup 0x7000 0x7000 | OutputData
* @{
* \brief Object 0x7000 (OutputData) definition
*/
#ifdef _OBJD_
/**
* \brief Object entry descriptions<br>
...
* \brief Object/Entry names
*/
OBJCONST UCHAR OBJMEM aName0x7000[] = "OutputData\000"
"SubIndex 001\000\377";
#endif //#ifdef _OBJD_
...
* \brief Object variable
*/
PROTO TOBJ7000 OutputData0x7000
#if defined(_SSC_DEVICE1_) && (_SSC_DEVICE1_ == 1)
={1,0x0000}
#endif
;
...
/* Object 0x1600 */
{NULL , NULL ,  0x1600 , {DEFTYPE_PDOMAPPING , 1 | (OBJCODE_REC << 8)} , asEntryDesc0x1600 , aName0x1600 , &OutputDataProcessDataMapping0x1600 , NULL , NULL , 0x0000 },
/* Object 0x1A00 */
{NULL , NULL ,  0x1A00 , {DEFTYPE_PDOMAPPING , 1 | (OBJCODE_REC << 8)} , asEntryDesc0x1A00 , aName0x1A00 , &InputDataProcessDataMapping0x1A00 , NULL , NULL , 0x0000 },
/* Object 0x1C12 */
{NULL , NULL ,  0x1C12 , {DEFTYPE_UNSIGNED16 , 1 | (OBJCODE_ARR << 8)} , asEntryDesc0x1C12 , aName0x1C12 , &sRxPDOassign , NULL , NULL , 0x0000 },
/* Object 0x1C13 */
{NULL , NULL ,  0x1C13 , {DEFTYPE_UNSIGNED16 , 1 | (OBJCODE_ARR << 8)} , asEntryDesc0x1C13 , aName0x1C13 , &sTxPDOassign , NULL , NULL , 0x0000 },
/* Object 0x6000 */
{NULL , NULL ,  0x6000 , {DEFTYPE_RECORD , 1 | (OBJCODE_REC << 8)} , asEntryDesc0x6000 , aName0x6000 , &InputData0x6000 , NULL , NULL , 0x0000 },
/* Object 0x7000 */
{NULL , NULL ,  0x7000 , {DEFTYPE_RECORD , 1 | (OBJCODE_REC << 8)} , asEntryDesc0x7000 , aName0x7000 , &OutputData0x7000 , NULL , NULL , 0x0000 },
/* Object 0xF000 */
...
/** @}*/
#define _SSC_DEVICE1_OBJECTS_H_
