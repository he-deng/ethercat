...
void wk_exint_config(void)
{
  ...
  gpio_init_struct.gpio_pins = CF1106_SYNC0_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_UP;
  gpio_init(CF1106_SYNC0_GPIO_PORT, &gpio_init_struct);
  ...
  gpio_default_para_init(&gpio_init_struct);
  gpio_init_struct.gpio_mode = GPIO_MODE_INPUT;
  gpio_init_struct.gpio_pins = CF1106_SYNC1_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_UP;
  gpio_init(CF1106_SYNC1_GPIO_PORT, &gpio_init_struct);
  ...
  gpio_default_para_init(&gpio_init_struct);
  gpio_init_struct.gpio_mode = GPIO_MODE_INPUT;
  gpio_init_struct.gpio_pins = CF1106_IRQ_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_UP;
  gpio_init(CF1106_IRQ_GPIO_PORT, &gpio_init_struct);
